...
public class ElanFrame2 extends JFrame implements ActionListener,
	 ...
	 * actions */
    private Map<String, MenuAction> menuActions = new HashMap<String, MenuAction>();
    ...
    private Map<Object, Action> registeredActions = new HashMap<Object, Action>();
...
//        }
    ...
    private void loadViewerPreferences(){
    	...
    	val = Preferences.get(ELANCommandFactory.COMMENT_VIEWER, null);
    	if (val instanceof Boolean) {
    		menuItemCommentViewer.setSelected((Boolean)val);    	
    	}
